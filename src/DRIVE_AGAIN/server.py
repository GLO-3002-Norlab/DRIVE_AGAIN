...
class Server:
    def __init__(self, start_drive_cb, start_geofencing_cb, skip_command_cb):
        self.app, self.socketio = self.create_server(start_drive_cb, start_geofencing_cb, skip_command_cb)
